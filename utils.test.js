  ...
  const expectedMappings = [
    {
      ...
      to: {
        test: /\.jsx?$/,
        use: ["speed-measure-extended-webpack-plugin/loader", "babel-loader"],
      },
    },
...

    {
      ...
      to: {
        test: /\.jsx?$/,
        use: [
          "speed-measure-extended-webpack-plugin/loader",
...

    {
      ...
      to: [
        ...
        {
          test: /\.css$/,
          use: ["speed-measure-extended-webpack-plugin/loader", "css-loader"],
        },
      ],
    },
  ];
